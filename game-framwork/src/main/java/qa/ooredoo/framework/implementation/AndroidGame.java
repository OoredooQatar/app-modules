...
import qa.ooredoo.framework.Audio;
import qa.ooredoo.framework.FileIO;
import qa.ooredoo.framework.Game;
import qa.ooredoo.framework.Graphics;
import qa.ooredoo.framework.Input;
import qa.ooredoo.framework.Screen;


// Fyrir Highscore

public abstract class AndroidGame extends BaseActivity implements Game {
