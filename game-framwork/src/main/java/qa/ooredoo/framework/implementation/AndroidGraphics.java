...
public class AndroidGraphics implements Graphics {
    ...
    @Override
    // Mynd byrjar � (x, y) e�a hefur mi�ju � (x, y), sn�i� um rotation�, sk�lu� � [scale*100%, scale*100%]
    public void drawImage(Image image, Matrix matrix, double x, double y,
