...
public class BannersResponse implements Serializable{
    ...
    public static BannersResponse fromJSON(String jsonString){
        if(jsonString == null || jsonString.length() < 1) return null;
        BannersResponse instance = new BannersResponse();
        try {
            JSONObject jsonObject = new JSONObject(jsonString);
            instance.setBanner(BannerData.fromJSON(jsonObject.optString("banner")));
