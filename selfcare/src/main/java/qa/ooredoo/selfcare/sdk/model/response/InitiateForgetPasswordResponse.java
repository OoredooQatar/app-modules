...
public class InitiateForgetPasswordResponse implements Serializable{
    ...
    public static InitiateForgetPasswordResponse fromJSON(String jsonString){
        if(jsonString == null || jsonString.length() < 1) return null;
        InitiateForgetPasswordResponse instance = new InitiateForgetPasswordResponse();
        try {
