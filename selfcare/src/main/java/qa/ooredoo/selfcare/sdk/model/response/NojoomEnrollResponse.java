...
public class NojoomEnrollResponse implements Serializable{
    ...
    public static NojoomEnrollResponse fromJSON(String jsonString){
        if(jsonString == null || jsonString.length() < 1) return null;
        NojoomEnrollResponse instance = new NojoomEnrollResponse();
        try {
